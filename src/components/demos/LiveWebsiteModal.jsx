...
const LiveWebsiteModal = ({ isOpen, onClose, initialSite = "aegis" }) => {
  ...
  const activeSite = DEPLOYED_WEBSITES[activeSiteKey] || DEPLOYED_WEBSITES.aegis;
      ...
      <div className="fixed inset-0 z-[10005] flex items-center justify-center p-2 sm:p-4 md:p-6 bg-black/90 backdrop-blur-lg">
        <motion.div
          ...
          <div className="px-4 py-3 bg-[#111111] border-b border-white/10 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1.5 pr-2 border-r border-white/10">
                <button
                  onClick={onClose}
                  className="w-3 h-3 rounded-full bg-white/20 hover:bg-white transition-colors"
                  title="Close Preview"
                />
                <button
            ...
            <div className="flex-1 max-w-xl mx-2">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-black/60 border border-white/10 text-white font-mono text-[12px]">
                <FaLock className="w-2.5 h-2.5 text-zinc-400 shrink-0" />
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/10 hover:bg-white hover:text-black text-white font-mono text-[11px] font-bold transition-colors border border-white/15">
          ...
          <div className="relative flex-1 w-full h-full bg-black overflow-hidden">
            {loading && (
              <div className="absolute inset-0 z-10 bg-[#090909] flex flex-col items-center justify-center space-y-4">
